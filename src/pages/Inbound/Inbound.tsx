...
const Inbound: React.FC = () => {
    ...
    const loadTransactions = () => {
        setTransactions(dataService.getTransactions(TransactionType.INBOUND));
    };
    ...
    const handleDelete = (id: string) => {
        ...
        if (result.success) {
            message.success('Inbound transaction deleted successfully');
            loadTransactions();
        } else {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (result.success) {
                message.success('Inbound transaction created successfully');
                ...
                <Space>
                    ...
                    {record.source === TransactionSource.USER && (
                        <Popconfirm
                            ...
                            description="Are you sure you want to delete this inbound transaction?"
        ...
        <div className="inbound-container">
            ...
            >
                <Form form={form} layout="vertical">
                    ...
                    <Form.Item label="Inbound Products List">
                                            ...
                                            <Space style={{ display: 'flex', marginBottom: 8 }} align="start">
                                                ...
                                                <Form.Item noStyle shouldUpdate>
                                                    {() => {
                                                        ...
                                                        return (
                                                            <div style={{ lineHeight: '32px', color: '#52c41a' }}>
                                                                ≈ {converted} (base unit)
                                                            </div>
                                                        );
                                                    }}
            ...
            {/* View Modal */}
            <Modal
                title={`Inbound Transaction Details #${viewingTransaction?.id}`}
